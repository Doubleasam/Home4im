...
class _AboutTablet extends StatelessWidget {
  ...
  const _AboutTablet(this.viewModel);
                              ...
                              child: Row(
                                children: [
                                  Image(
                                    ...
                                    fit: BoxFit.fill,
                                    image: const AssetImage('assets/images/house-icon.png'),
                                  ),
                                  Flexible(
                                    child: ListTile(
                                ...
                                children: [
                                  Container(
                                    child: Image(
                                      height: context.width * 0.16,
                                      fit: BoxFit.fill,
                                      image: const AssetImage('assets/images/strong-icon.png'),
                                    ),
                                  ),
                                  Flexible(
                                    child: ListTile(
                              ...
                              child: Row(
                                children: [
                                  Image(
                                    height: context.width * 0.16,
                                    fit: BoxFit.fill,
                                    image: const AssetImage('assets/images/person-icon.png'),
                                  ),
                                  Flexible(
                                    child: Container(
                                      child: ListTile(
                                ...
                                children: [
                                  Container(
                                    child: Image(
                                      height: context.width * 0.16,
                                      fit: BoxFit.fill,
                                      image: const AssetImage('assets/images/stable-icon.png'),
                                    ),
                                  ),
                                  Flexible(
                                    child: Container(
