...
class _PrivacyPolicyTablet extends StatefulWidget {
  final PrivacyPolicyViewModel viewModel;

  const _PrivacyPolicyTablet(this.viewModel);

  @override
  State<_PrivacyPolicyTablet> createState() => _PrivacyPolicyTabletState();
}

class _PrivacyPolicyTabletState extends State<_PrivacyPolicyTablet> {
    var header = true;
