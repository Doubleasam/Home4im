              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(20),
                    InkWell(onTap: () => Get.toNamed(AboutView.routeName), child: Text('About', style: context.textTheme.bodyMedium?.copyWith(color: Colors.white))),
                    const Gap(10),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(10),
                    InkWell(onTap: () => Get.toNamed(ContactView.routeName), child: Text('Contact', style: context.textTheme.bodyMedium?.copyWith(color: Colors.white))),
                    const Gap(10),
